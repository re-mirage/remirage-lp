const siteMetadata = {
  title: 'Remirage',
  author: 'MOHAMED EL BSSIR',
  headerTitle: 'Remirage',
  description: "Move fast. Don't break things.",
  language: 'en-us',
  theme: 'system',
  siteUrl: 'https://www.remirage.com',
  siteRepo: 'https://github.com/https://github.com/re-mirage/remirage-lp',
